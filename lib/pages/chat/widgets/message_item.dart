  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: isMe ? [content, avatar] : [avatar, content],
      ),
    );
  }
}
      ...
      case MessageType.card:
        return Row(
          ...
          children: [
            ...
            SizedBox(width: 6.w),
            Text(
              message.cardElem?.nickname ?? message.cardElem?.userID ?? "名片",
              style: theme.textTheme.bodyMedium?.copyWith(color: textColor),
            ),
          ],
        );
          ...
          children: [
            ...
            for (final a in abstracts.take(3))
              Text(
                ...
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style: theme.textTheme.bodySmall?.copyWith(color: textColor.withValues(alpha: 0.9)),
              ),
          ],
        );
